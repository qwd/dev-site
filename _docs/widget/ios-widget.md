...
![sample](/assets/images/widget-ios-sample2.jpg)
...
#### 3.1.1 QWeatherPluginViewType说明
...
| backgroundImageTitle         | 自定义视图背景图片标题:当themType的值为QWeatherPluginViewThemeTypeAuto时设置有效,图片命名规则为白天xxx_code_d，夜晚xxx_code_n 其中code参看和[风天气状况代码](/docs/start/icons) 传入xxx前缀即可 |                                                                             |                                                                       |
|                              | NSString                                                                                                                                                                                                                  | 无                                                                          |                                                                       |
...
| dragDirection                | 拖拽的方向                                                                                                                                                                                                                | [QWeatherPluginViewDragDirection](#QWeatherPluginViewDragDirection)（枚举类型） | QWeatherPluginViewDragDirectionAny                                      |
...
<span id="QWeatherConfigModelType"> QWeatherConfigModelType </span>
...
#### <span id="QWeatherContentViewAlignment">3.2.2 QWeatherContentViewAlignment</span>
...
#### <span id="QWeatherPluginViewThemeType">3.2.3 QWeatherPluginViewThemeType</span>
...
#### <span id="QWeatherPluginViewDragDirection">3.2.4 QWeatherPluginViewDragDirection</span>
