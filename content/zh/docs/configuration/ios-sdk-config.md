...
当前iOS SDK的最新版本是5.2.1([更新记录](https://blog.qweather.com/release/sdk/))，支持下列安装方式：
...
1. 下载SDK：[QWeatherSDK 5.2.1](https://github.com/qwd/qweather-ios-sdk/releases/tag/5.2.1)
