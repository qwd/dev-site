...
Therefore, when a user does not use QWeather products for 12 months, we mark the user's account as an <strong>Inactive Account</strong> and all inactive accounts will be deleted from the QWeather Developers Service.

## What is Inactive

<strong>Inactive</strong> means that in a 12 months period the user has not:
