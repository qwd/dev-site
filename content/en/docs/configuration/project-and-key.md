...
To add JWT credentials, you need to create Ed25519 public and private keys first, see [Authentication - Generate Ed25519](/docs/configuration/authentication/#generate-ed25519-key).
