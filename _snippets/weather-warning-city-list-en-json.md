...
```
// Warning city list 
// Pro API:  https://api.qweather.com/v7/warning/list?range=cn&lang=en&key=YOUR_KEY
// Dev API:  https://devapi.qweather.com/v7/warning/list?range=cn&lang=en&key=YOUR_KEY
